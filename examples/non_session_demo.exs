...
# Run with: elixir examples/non_session_demo.exs [pool_size]
# Example: elixir examples/non_session_demo.exs 8
...
pool_size = case System.argv() do
  ...
  [] ->
    ...
    4
  _ ->
    IO.puts("⚠️ Usage: elixir examples/non_session_demo.exs [pool_size]")
